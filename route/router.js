...
var Comment = require('../app/controllers/movie/movie_comment'); // 电影评论控制器
...
var MusicIndex = require('../app/controllers/music/music_index'); // 音乐首页控制器 // 音乐首页模块路由控制器
var Music = require('../app/controllers/music/music');   // 音乐模块路由控制器
/* 音乐分类控制器 */
var MusicCategory = require('../app/controllers/music/music_category');
/* 音乐热门榜单控制器 */
var Programmer = require('../app/controllers/music/music_programme');
...
module.exports = function(app){
	...
	*/
	...
	//admin update musicCategory 查看豆瓣音乐分类路由
	// app.get('/admin/music/musicCategory/:id',User.signinRequired,User.adminRequired,MusicCategory.detail);
	//更新豆瓣音乐分类路由
